...
{
    internal class SurveyMonkeyAuthenticationHandler : AuthenticationHandler<SurveyMonkeyAuthenticationOptions>
    {
        private readonly ILogger _logger;
        private readonly HttpClient _httpClient;

        public SurveyMonkeyAuthenticationHandler(ILogger _logger, HttpClient _httpClient)
        {
        ...
        protected override Task ApplyResponseChallengeAsync()
        {
            ...
            if (challenge != null)
            {
                ...
                var redirectContext = new SurveyMonkeyApplyRedirectContext(
                    Context, Options,
        ...
        public async Task<bool> InvokeReturnPathAsync()
        {
            ...
            var context = new SurveyMonkeyReturnEndpointContext(Context, model);
